...
vim.keymap.set("n", "<leader>wk", ":resize +15<CR>", { desc = "Increase height" })
vim.keymap.set("n", "<leader>wj", ":resize -15<CR>", { desc = "Decrease height" })
vim.keymap.set("n", "<leader>wl", ":vertical resize +15<CR>", { desc = "Increase width" })
vim.keymap.set("n", "<leader>wh", ":vertical resize -15<CR>", { desc = "Decrease width" })
